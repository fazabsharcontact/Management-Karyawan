                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 border-b pb-4">
                        ...
                        <p class="text-gray-500 mt-1 text-sm">
                            Ubah data jenis potongan yang sudah terdaftar di sistem.
                        </p>
                    </div>

                    <form method="POST" action="{{ route('admin.master-potongan.update', $masterPotongan->id) }}" class="space-y-5">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="number" name="jumlah_default" id="jumlah_default"
                                value="{{ old('jumlah_default', $masterPotongan->jumlah_default) }}"
                                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-gray-300 focus:border-gray-400 transition"
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="3"
                                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-gray-300 focus:border-gray-400 transition"
                                placeholder="Tuliskan deskripsi singkat jika diperlukan">{{ old('deskripsi', $masterPotongan->deskripsi) }}</textarea>
                        </div>
