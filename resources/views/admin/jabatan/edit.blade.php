                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 border-b pb-4">
                        ...
                        <p class="text-gray-500 mt-1 text-sm">
                            Ubah data jabatan sesuai kebutuhan, lalu simpan perubahan.
                        </p>
                    </div>

                    <form method="POST" action="{{ route('admin.jabatan.update', $jabatan->id) }}" class="space-y-5">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="number" name="gaji_awal" id="gaji_awal"
                                value="{{ old('gaji_awal', $jabatan->gaji_awal) }}"
                                class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-gray-300 focus:border-gray-400 transition"
                                required>
                        </div>
