    ...
    <div class="p-6">
        <div class="bg-white rounded-lg shadow p-6 space-y-8">
            ...
            <div class="bg-gray-50 rounded-lg border border-gray-200 p-6">
                ...
                <form action="{{ route('admin.cuti.resetTahunan') }}" method="POST"
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form method="GET" class="flex flex-wrap items-center gap-3 mb-4">
                    <input type="text" name="search" placeholder="Cari nama pegawai..."
                        class="border-gray-300 rounded-md shadow-sm text-sm" value="{{ request('search') }}">
                            ...
                            @forelse($cutis as $cuti)
                                <tr class="hover:bg-gray-50">
                                    <td class="border-b px-4 py-2">
                                        <div class="font-medium">{{ $cuti->pegawai->nama ?? 'N/A' }}</div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="overflow-x-auto">
                    ...
                    <div class="mt-4">
                        {{ $pegawais->appends(request()->query())->links('vendor.pagination.tailwind') }}
                    </div>
                </div>
            </div>
        </div>
