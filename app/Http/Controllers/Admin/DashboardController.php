...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $jangkauanWaktu = Carbon::now()->subDays(365); // Diubah dari 7 menjadi 365 hari
        ...
        // --- LANGKAH DEBUGGING PALING PENTING ---
        // Tampilkan semua variabel dan hentikan eksekusi
        dd($totalPegawai, $totalGaji, $jabatanData, $aktivitas);
